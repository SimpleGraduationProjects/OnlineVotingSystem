...
public class ExamrecordController {
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids){
        ...
        List<ExamrecordEntity> examrecordE = examrecordService.selectBatchIds(Arrays.asList(ids));//投票记录表
...
//                            examrecordEntity.setExamrecordUuidNumber(data.get(0));                    //投票编号 要改的
//                            examrecordEntity.setYonghuId(Integer.valueOf(data.get(0)));   //投票用户 要改的
...
//                            examrecordEntity.setCreateTime(date);//时间
                        ...
                        if(examrecordEntities_examrecordUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [投票编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
