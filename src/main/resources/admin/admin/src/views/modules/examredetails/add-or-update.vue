    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投票编号" prop="examredetailsUuidNumber">
                       <el-input v-model="ruleForm.examredetailsUuidNumber"
                                 placeholder="投票编号" clearable  :readonly="ro.examredetailsUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="投票编号" prop="examredetailsUuidNumber">
                           <el-input v-model="ruleForm.examredetailsUuidNumber"
