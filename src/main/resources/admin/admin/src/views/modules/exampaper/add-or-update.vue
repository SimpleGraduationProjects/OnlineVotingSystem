        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投票名称" prop="exampaperName">
                       <el-input v-model="ruleForm.exampaperName"
                                 placeholder="投票名称" clearable  :readonly="ro.exampaperName"></el-input>
                   </el-form-item>
                   <div v-else>
			   ...
			   <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="投票状态" prop="exampaperTypes">
                        <el-select v-model="ruleForm.exampaperTypes" placeholder="请选择投票状态">
                            <el-option
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   exampaperTypes: [
                              { required: true, message: '投票状态不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
