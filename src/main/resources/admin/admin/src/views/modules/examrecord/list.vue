		...
		<div v-if="showFlag">
			<el-form :inline="true" :model="searchForm" class="form-content">
				<el-row :gutter="20" class="slt"
					...
					<el-form-item :label="contents.inputTitle == 1 ? '投票名称' : ''">
						<el-input prefix-icon="el-icon-search" v-model="searchForm.exampaperName" placeholder="投票名称"
							clearable></el-input>
					</el-form-item>



					<el-form-item :label="contents.inputTitle == 1 ? '投票状态' : ''">
						<el-select v-model="searchForm.exampaperTypes" placeholder="请选择投票状态">
			...
			<div class="table-content">
				<el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
						prop="examrecordUuidNumber" header-align="center" label="投票编号">
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
						prop="exampaperName" header-align="center" label="投票名称">
						<template slot-scope="scope">
					...
					<el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="insertTime"
						header-align="center" label="投票时间">
						<template slot-scope="scope">
					...
					<el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
						<template slot-scope="scope">
							<el-button v-if="isAuth('examrecord','查看')" type="success" icon="el-icon-tickets"
								...
								{{ contents.tableBtnFont == 1?'查看投票详情':'' }}</el-button>
