        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='exampaper'">
                    <el-form-item class="select" v-if="type!='info'"  label="投票表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" filterable placeholder="请选择投票表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="投票名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="投票名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="投票名称" prop="exampaperName">
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="投票状态" prop="exampaperValue">
                        <el-input v-model="exampaperForm.exampaperValue"
                                  placeholder="投票状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="投票状态" prop="exampaperValue">
                            <el-input v-model="ruleForm.exampaperValue"
                                      placeholder="投票状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投票编号" prop="examrecordUuidNumber">
                       <el-input v-model="ruleForm.examrecordUuidNumber"
                                 placeholder="投票编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="投票编号" prop="examrecordUuidNumber">
                           <el-input v-model="ruleForm.examrecordUuidNumber"
                                     placeholder="投票编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            ...
            return {
                ...
                rules: {
                   examrecordUuidNumber: [
                              { required: true, message: '投票编号不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                              { required: true, message: '投票用户不能为空', trigger: 'blur' },
                          ],
                   exampaperId: [
                              { required: true, message: '所属投票id（外键）不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
